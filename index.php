...
<head>
    ...
    <meta name="description"
        content="Reezza adalah sebuah website portfolio dari Muhammad Reza Khafidz yang berisi tentang pengalaman bekerja dan berbagai projek yang telah saya kerjakan. Hubungi saya di email: admin@reezza.com">
    <meta name="keywords" content="Reezza, Muhammad Reza Khafidz, Programmer, Coding, Design">
    ...
    <meta property="og:description"
        content="Reezza adalah sebuah website portofolio dari Muhammad Reza Khafidz yang berisi tentang pengalaman bekerja dan berbagai projek yang telah saya kerjakan. Hubungi saya di email: admin@rezashadow.com" />
        ...
        <div class="container">
            <div class="row">
                <div id="text" class="mobile-container primaryTextColor py-5">
                    <div>
                        <p class="h1">
                            Hello World! Saya Muhammad Reza Khafidz 👋
                        </p>

                        <p class="lh-lg py-3">
                            Situs ini berisi tentang pengalaman bekerja dan berbagai projek yang telah saya kerjakan.
                            Saya adalah seorang Programmer dan Drone Pilot. Untuk Programmer sendiri, saya bekerja
                            menggunakan &nbsp; <ion-icon name="logo-laravel"></ion-icon> &nbsp; Framework Laravel,
                            &nbsp;
                            <ion-icon name="logo-android"></ion-icon> &nbsp; Framework Flutter, &nbsp; <ion-icon
                                name="logo-html5"></ion-icon> &nbsp; HTML 5, &nbsp; <ion-icon name="logo-css3">
                            </ion-icon>
                            &nbsp; CSS Tailwind dan Bootstrap.
                            Selain itu saya juga bekerja dengan CMS, salah satunya yaitu &nbsp; <ion-icon
                                name="logo-wordpress">
                            </ion-icon> &nbsp; Wordpress.
                            Untuk pekerjaan sebagai drone pilot, saya menggunakan &nbsp; <ion-icon
                                name="airplane-outline">
                            </ion-icon> &nbsp; DJI Mavic 2 Zoom.
                            Saya juga tertarik untuk traveling lho.
                            ...
                            <a href="mailto:admin@rezashadow.com" id="highlighted-text"
                                class="email-text highlighted-text">admin@rezashadow.com</a> atau silakan menuju ke
                            halaman <a href="<?php echo $baseUrl; ?>/contact" data-bs-toggle="popover"
                                data-bs-trigger="hover focus" data-bs-content="Klik disini menuju ke halaman contact"
                                class="primaryTextColor text-decoration-none" id="contact-me">
                                Contact </a>.
                        </p>
                    </div>
                    ...
                    <div class="py-3">
                        ...
                        <div>
                            <p class="py-2">
                                <img src="storage/images/experience/astramaya-logo.png" class="img-fluid"
                                    alt="Logo Botika" width="25">
                                &nbsp; Full Stack Developer at Astramaya <br>
                                <span class="font-monospace font-weigt-light">December 2019 - March 2021,
                                    Depok.</span>
                            </p>
                        </div>
                        ...
                        <div>
                            <p class="py-2">
                                <img src="storage/images/experience/astramaya-logo.png" class="img-fluid"
                                    alt="Logo Botika" width="25"> &nbsp; Drone Pilot at Astramaya
                                <br>
                                <span class="font-monospace font-weigt-light">December 2019 - March 2021,
                                    Depok.</span>
                            </p>
                        ...
                        <div>
                            <p class="py-2">
                                <ion-icon name="code-slash-outline"></ion-icon> &nbsp; Full Stack Developer at PT.
                                Marakata
                                Unggul Sejahtera <br>
                                <span class="font-monospace font-weigt-light">December 2019 - March 2021,
                                    Depok.</span>
                        ...
                        <div>
                            <p class="py-2">
                                <ion-icon name="airplane-outline"></ion-icon> &nbsp; Drone Pilot at Employee Gathering
                                2019 | PT. Indonesia Power Kantor Pusat
                                <br>
                                <span class="font-monospace font-weigt-light">23 June 2019,
                                    Karimunjawa.</span>
                            </p>
                        </div>
                        ...
                        <div>
                            <p class="py-2">
                                <ion-icon name="airplane-outline"></ion-icon> &nbsp; Drone Pilot at Jalan Sehat Arus
                                Bawah Jokowi Tuban
                                <br>
                                <span class="font-monospace font-weigt-light">20 January 2019,
                                    Tuban.</span>
                            </p>
                        </div>
                        ...
                        <div>
                            <p class="py-2">
                                <ion-icon name="airplane-outline"></ion-icon> &nbsp; Drone Pilot at Jalan Sehat Arus
                                Bawah Jokowi Bojonegoro
                                <br>
                                <span class="font-monospace font-weigt-light">9 December 2018,
                                    Bojonegoro.</span>
                            </p>
                        </div>
                        ...
                        <div>
                            <p class="py-2">
                                <img src="storage/images/experience/indonesia-logo.png" class="img-fluid"
                                    alt="Logo Botika" width="20">
                                &nbsp; Full Stack Developer at Jokowi Campaign <br>
                                <span class="font-monospace font-weigt-light">August 2018 - April 2019,
                                    Jakarta.</span>
                            </p>
                        </div>
                        ...
                        <div>
                            <p class="py-2">
                                <img src="storage/images/experience/botika_logo.png" class="img-fluid" alt="Logo Botika"
                                    width="20">
                                &nbsp; Backend
                                Programmer Chatbot at Botika | PT. RuangKerja Software Engineering <br>
                                <span class="font-monospace font-weigt-light">June 2018 - July 2018, Yogyakarta.</span>
                            </p>
                        </div>
                        ...
                        <div>
                            <p class="py-2">
                                <img src="storage/images/experience/botika_logo.png" class="img-fluid" alt="Logo Botika"
                                    width="20">
                                &nbsp; Internship at Botika | PT. RuangKerja Software Engineering <br>
                                <span class="font-monospace font-weigt-light">-, Yogyakarta.</span>
                            </p>
                        </div>

                        <div>
                            <p class="py-2">
                                <img src="storage/images/experience/blc-telkom-klaten-logo.png" class="img-fluid"
                                    alt="Logo Botika" width="25">
                                &nbsp; Internship at BLC Telkom Klaten <br>
                                <span class="font-monospace font-weigt-light">December 2015 - March 2016,
                                    Klaten.</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="py-3">
                        ...
                        <div>
                            <a href="<?php echo $baseUrl; ?>/portfolio"
                                class="badge text-decoration-none btn-primaryTextColor btnSecondaryBgColor btn-shadow"
                                id="btn-lihat-semuanya">Lihat
                                Semuanya</a>
                        </div>
                        <hr>
                        <div class="row py-2 gx-3 gy-3 font-size-14">
